# pymrm
pymrm is a syndicated set of .py methods for econometric, stochastic, time-series, machine learning, gis, nlp and other modeling 

**Py MRM stands for Python Model Risk Management.** <br>
